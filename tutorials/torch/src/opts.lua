...
function M.parse(arg)
    ...
    cmd:text()
    cmd:option('-evalMode',                 false, 'Train or test')
    ...
    cmd:option('-name',                 'myModel', 'Name of model to save') 
    cmd:text()
    ...
    cmd:text()
    cmd:option('-testBatchSize',       1, 'Mini-batch size for testing/validation (currently unused)')
    cmd:text()
